...
import { MapPinIcon, PencilIcon, TrashIcon, XIcon } from "lucide-react";
    ...
    <div className="mb-8">
      ...
      {showAllPhotos && (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
          <div className="bg-white p-4 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto relative">
            <button
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              {PropertyDetailsData.images.map((id, index) => (
                <div key={index} className="relative w-full aspect-[4/3] rounded-lg overflow-hidden">
                  <Image
                    src={`https://limpiar-backend.onrender.com/api/properties/gridfs/files/${id}`}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-4 md:p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div
                className="relative aspect-[4/3] md:aspect-video w-full overflow-hidden rounded-lg group cursor-pointer"
