              ...
              filteredBookings.map((booking) => (
                <tr key={booking._id} className="bg-white hover:bg-gray-50">
                  ...
                  <td className="p-3 sm:p-4 border border-gray-200">
                    <button
                      onClick={() => handleBookingClick(booking)}
                      className="text-blue-600 whitespace-nowrap hover:text-blue-800 hover:underline focus:outline-none"
                    >
                      {booking.propertyId?.name || "N/A"}
                    </button>
                  </td>
                  ...
                  <td className="p-3 sm:p-4 border whitespace-nowrap border-gray-200">
                    {booking.startTime || "N/A"}
                  </td>
