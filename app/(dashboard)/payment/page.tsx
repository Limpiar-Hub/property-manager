      ...
      <main className="flex-1 overflow-auto pb-20 md:pb-0">
        ...
        <div className="p-6">
          ...
          {/* <div className="max-w-md mx-auto md:mx-0 mb-8">
            <div className="bg-[#2D82FF] rounded-lg p-6 text-white relative overflow-hidden">
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              ...
              <button className="flex items-center justify-center gap-2 bg-gray-100 hover:bg-gray-200 transition-colors p-3 rounded-lg text-sm font-medium">
        ...
        Top Up Wallet
                ...
                {/* <button className="flex items-center justify-center gap-2 bg-gray-100 hover:bg-gray-200 transition-colors p-3 rounded-lg text-sm font-medium w-full"> */}
                <button
                  // onClick={() => dispatch(openModal("refund"))}
                  className="flex items-center justify-center gap-2 bg-gray-100 hover:bg-gray-200 transition-colors p-3 rounded-lg text-sm font-medium"
                >
                  <RefreshCcw className="w-4 h-4" />
                  Request Refund
