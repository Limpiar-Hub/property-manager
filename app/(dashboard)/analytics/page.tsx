        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-8 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <span className="text-sm text-gray-500 dark:text-gray-400">{getLastUpdatedText()}</span>
              <button
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transition-all duration-300 hover:shadow-xl">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div className={`flex items-center p-4 bg-gray-100 dark:bg-gray-700 rounded-lg transition-all duration-200 hover:scale-105 ${isLive ? 'animate-pulse-once' : ''}`}>
                  ...
                  <div className={`flex items-center p-4 bg-gray-100 dark:bg-gray-700 rounded-lg transition-all duration-200 hover:scale-105 ${isLive ? 'animate-pulse-once' : ''}`}>
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 transition-all">${analytics.dashboard.avgBookingValue.toLocaleString()}</p>
                    </div>
                  </div>
                  <div className={`flex items-center p-4 bg-gray-100 dark:bg-gray-700 rounded-lg transition-all duration-200 hover:scale-105 ${isLive ? 'animate-pulse-once' : ''}`}>
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 transition-all">${analytics.dashboard.walletBalance.toLocaleString()}</p>
                    </div>
                  </div>
                </div>
              </div>
